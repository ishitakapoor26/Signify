...
List<String> isl_gif = ['any questions', 'are you angry', 'are you busy', 'are you hungry', 'are you sick', 'be careful',
...
class _ConverState extends State<Conver> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      image: NetworkImage("https://thumbs.dreamstime.com/b/vector-deaf-mute-sign-language-character-gesture-men-women-showing-basic-symbol-smiling-sketch-female-male-hand-communication-134983662.jpg"), fit: BoxFit.cover),
      ),
